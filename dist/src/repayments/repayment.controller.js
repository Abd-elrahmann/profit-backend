...
let RepaymentController = class RepaymentController {
    ...
    uploadPaymentProofBulk(req, file, repaymentIds) {
        return this.repaymentService.uploadPaymentProofBulk(req.user.id, repaymentIds, file);
    }
};
...
__decorate([
    (0, common_1.Post)('payment-proof-bulk'),
    (0, permissions_decorator_1.Permissions)('repayments', 'canPost'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file')),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.UploadedFile)()),
    __param(2, (0, common_1.Body)('repaymentIds')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Array]),
    __metadata("design:returntype", void 0)
], RepaymentController.prototype, "uploadPaymentProofBulk", null);
