...
let AuditLogController = class AuditLogController {
    ...
    async getAllLogs(page, limit = 10, userId, screen, action, userName, from, to) {
...
__decorate([
    (0, common_1.Get)(':page'),
    (0, permissions_decorator_1.Permissions)('logs', 'canView'),
    __param(0, (0, common_1.Param)('page', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('limit')),
    __param(2, (0, common_1.Query)('userId')),
    __param(3, (0, common_1.Query)('screen')),
    ...
    __metadata("design:paramtypes", [Number, Object, Number, String, String, String, String, String]),
