...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('users', 'canAdd'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.Permissions)('users', 'canUpdate'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('users', 'canDelete'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':page'),
    (0, permissions_decorator_1.Permissions)('users', 'canView'),
